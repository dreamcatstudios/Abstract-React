...
const QuestCard = () => {
  ...
  const [questData, setQuestData] = useState({
    ...
    adam_10: {
      ...
      description:
        "Heatmaps track user clicks, scrolls, and navigation on a website, using color intensity to highlight activity. Webmasters leverage heatmaps to analyze user behavior, identify popular features, and optimize site design for running targeted ads.",

      learningPath: [
        {
          level: 1,
          title: "What type of headphones was Adam looking for?",
          clicked: false,
          disabled: false,
          answer: "1",
        ...
        {
          level: 2,
          title: "At what price range was Adam looking for headphones?",
          answer: "test2",
          explanation: "This is because of the following reasons",
          clicked: false,
          disabled: false,
        ...
        {
          level: 3,
          title: "Did Adam sign up for any newsletters?",
          clicked: false,
          disabled: false,
          answer: "test3",
          explanation: "This is because of the following reasons",
        ...
        },
        {
          level: 4,
          title:
            "What are the chances that Adam bought a headphone during his site activity?",
          clicked: false,
          disabled: false,
          answer: "test4",
          explanation: "This is because of the following reasons",
        ...
        {
          level: 5,
          title: "How frequently does Adam engage in online shopping?",
          clicked: false,
          disabled: false,
          answer: "test5",
          explanation: "This is because of the following reasons",
