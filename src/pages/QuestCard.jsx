...
const QuestCard = () => {
  ...
  const [questData, setQuestData] = useState({
    ...
    jim_09: {
      ...
      fileName: "Smart_Home.zip",
      points: 0,
      fileDownload: "/assets/conversations.zip",
      ...
      learningPath: [
        {
          level: 1,
          title: "What are Jim's music preferences?",
          clicked: false,
          disabled: false,
          answer: "1",
          explanation: "Some searches suggest he prefers K-POP.",
          options: "[K-POP, J-Pop, Jazz]",
        },
        {
          level: 2,
          title: "What do we know about this person's exercise habits?",
          clicked: false,
          disabled: false,
          answer: "2",
          explanation: "Some searches suggest he does light exercise.",
          options: "[Sedentary, light, active]",
        },
        {
          level: 3,
          title: "What do we know about Jim's dietary restrictions?",
          clicked: false,
          disabled: false,
          answer: "1",
          explanation: "Some searches suggest he has dietary restrictions.",
          options: "[Gluten-free, lactose intolerant, Can't tell]",
        },
        {
          level: 4,
          title: "What do we know about Jim's dietary restrictions?",
          ...
          disabled: false,
          answer: "1",
          explanation: "Some searches suggest that he lives in Utah.",
          options: "[Utah, Washington, Idaho]",
        },
        {
          level: 5,
          title: "What do we know about Jim's transportation methods? ",
          clicked: false,
          disabled: false,
          answer: "3",
          explanation: "Some searches suggest he uses public transit.",
          options: "[car owner, cyclist, Public transit rider]",
        },
      ],
    },
    adam_10: {
